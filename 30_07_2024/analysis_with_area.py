...
# import torch
# from datetime import datetime
from analysis_using_Mask_R_CNN import analysis_by_Mask_R_CNN
from analysis_using_Mask_R_CNN import calculate_average_area_of_rectangle
from analysis_using_Mask_R_CNN import List_of_error_frames
...
if __name__ =='__main__':
    try:
        ...
        if len(argv) <= 6 :
            ...
            error_frame_json ={"object_detection":[]}
            average_of_rectangle = calculate_average_area_of_rectangle(video_id)
            error_frames = List_of_error_frames(average_of_rectangle,video_id)
            error_frames_json_folder_path =f'{basedir}/{camera_id}_videos_json/un_uploaded_json/error_frame_json/'
            
            analysis_by_Mask_R_CNN(video_file_path,video_id,error_frames,error_frame_json,video_time,video_date,error_frames_json_folder_path)
