...
try:
    ...
    image_path = '/home/ubuntu/Try_code/camera_ip_101/frames/1.jpg'
    ...
    for box in Boxes:
        ...
        obj = label[i].item()
        if obj== 0 and float(confidence)>=0.90 :
    ...
    cv2.imwrite('/home/ubuntu/Try_code/camera_ip_101/predict_frames/camera_ip_101_5.jpg',image)
